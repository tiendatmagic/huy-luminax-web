  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3.5 items-end select-none">
        ...
        {/* 3. Nút Facebook */}
        {settings.widget_facebook_show === "1" &&
          settings.widget_facebook_value && (
            <div className="relative group">
        ...
        {/* 4. Nút Messenger */}
        {settings.widget_messenger_show === "1" &&
          settings.widget_messenger_value && (
            <div className="relative group">
        ...
        {/* 5. Nút Instagram */}
        {settings.widget_instagram_show === "1" &&
          settings.widget_instagram_value && (
            <div className="relative group">
        ...
        {/* 6. Nút Hỗ trợ */}
        {settings.widget_contact_show === "1" &&
          settings.widget_contact_value && (
            <div className="relative group">
              <div className="absolute -inset-1 rounded-full bg-blue-500/35 blur-sm opacity-70 group-hover:opacity-100 animate-pulse-slow"></div>
              <Link
