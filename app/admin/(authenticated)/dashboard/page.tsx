    ...
    <div className="p-6 md:p-8 space-y-8">
      ...
      <div className="relative rounded-3xl bg-gradient-to-r from-[#0f172a] via-[#1e293b] to-[#0f172a] text-white p-6 md:p-8 overflow-hidden shadow-xl border border-white/5">
        ...
        <div className="max-w-xl relative z-10 space-y-3">
          <span className="text-xs font-black tracking-widest text-primary uppercase bg-primary/10 px-3 py-1 rounded-full border border-primary/20">
            Luminax AI Ready
          </span>
          <h1 className="font-headline text-2xl md:text-3xl font-black">
            Chào mừng quay trở lại, {currentUser?.name || "Admin"}!
          </h1>
          <p className="text-sm text-slate-300 font-semibold leading-relaxed">
            Hệ thống quản trị Huy Luminax đang hoạt động ổn định. Bạn có toàn
            quyền cấu hình dữ liệu sản phẩm, tin tức, thông tin công nghệ và
            tương tác với các yêu cầu từ khách hàng.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <div
            key={idx}
            className="bg-white border border-black/5 rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col justify-between relative overflow-hidden group"
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <div
                className={`w-11 h-11 rounded-2xl bg-gradient-to-tr ${stat.color} flex items-center justify-center text-white shadow-sm group-hover:scale-110 transition-transform duration-300`}
              >
                <stat.icon className="w-5 h-5" />
              </div>
            </div>
            <div className="space-y-1">
              <h3 className="text-3xl font-black text-deep-navy">
                {stat.value}
              </h3>
