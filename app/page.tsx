  ...
  return (
    <div className="flex flex-col min-h-screen relative selection:bg-primary/20 selection:text-primary">
      ...
      <main className="flex-grow">
        ...
        <section
          id="contact-section"
          className="py-20 px-6 max-w-7xl mx-auto relative reveal"
        >
          <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
          ...
          <div className="glass-premium rounded-[2.5rem] p-8 md:p-12 border border-white/45 relative overflow-hidden shadow-2xl text-center space-y-8 relative z-10">
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-xs sm:text-sm md:text-base text-on-surface-variant max-w-xl mx-auto leading-relaxed font-medium">
